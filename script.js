...
function consultar_ip() {
  // Fetch da API por IP
  let url = 'https://cors.io/?https://api.hgbrasil.com/weather?format=json-cors&key=0bc8de826&user_ip=remote'
...
function consultar() {
  ...
  let url = `https://cors.io/?https://api.hgbrasil.com/weather?format=json-cors&key=0bc8de82&city_name=${cidade}`
